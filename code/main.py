...
posPuits = []
limVersant = []
for i in range(nb_test): # On prend 10 instances ici, mais l'utilisateur peut choisir la valeur qu'il souhaite
    # Format: voir instance_montagne.py, on utilise random pour plus d'aléatoire dans la génération d'instance
    posPuits_i, limVersant_i = creeInstance(10,16,i,0.1,0.3,30)
